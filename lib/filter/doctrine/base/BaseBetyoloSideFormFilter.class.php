...
/**
 * BetyoloSide filter form base class.
 *
 * @package    betyolo
 * @subpackage filter
 ...
 */
abstract class BaseBetyoloSideFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('betyolo_side_filters[%s]');
